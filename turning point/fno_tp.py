...
model = fourier_tp.FNO1d(modes, width,begin,end).cuda()
...
np.save("residual_fno_tp.npy",residual)
# np.save("loss_fno_1d.npy",loss)
torch.save(model.state_dict(),"model_ep001_fno_tp.pt")