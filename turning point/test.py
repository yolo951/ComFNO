...
residual = np.load('residual_spno_tp.npy')
r_fno = np.load('residual_fno_tp.npy')
x_grid = np.linspace(-1,1,r_fno.shape[-1])
fig, ax = plt.subplots()
...
ax.set_xticklabels(['-1', '', '', '', '1'], fontsize=15)
ax.set_yticks([-0.05, 0, 0.05, 0.1, 0.15, 0.2])
ax.set_yticklabels(['-0.05', '', '', '', '', '0.2'], fontsize=15)
...
xlim0, xlim1, ylim0, ylim1 = -1, 1, -0.02, 0.02
...
fig.savefig(r'ordinary_tp_residual.png', dpi=300)
