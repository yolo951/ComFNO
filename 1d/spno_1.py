...
eps=0.001
ntrain = 900
# ntrain=100 # for few-shot case
ntest = 100

batch_size = 30  #=25 for few-shot case
learning_rate = 0.001

epochs = 500  #=2000 for few-shot case
step_size = 50  #=150 for few-shot case
gamma = 0.5
...
# x_train = x_data[:ntrain, ::10]  #for few-shot case
...
torch.save(model.state_dict(),"model_ep001_spno_1d.pt")
# np.save("data/fno_loss_1.npy",loss)
np.save("residual_spno_1d.npy",residual)