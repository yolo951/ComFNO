...
from SPNO_multiple_eps import *
from scipy.stats import multivariate_normal

x_data = np.load('spde_mul_x.npy')
y_data = np.load('spde_mul_y.npy')
eps = x_data[:,-1][:,None]
...
# np.save('residual_spno_multi_eps.npy',residual)
# np.save("loss_spno_mul.npy",loss)
# torch.save(model.state_dict(),"model_spno_mul_eps.pt")